...
level_of_complexity25_test = read_file("uploads/{}".format(sys.argv[1]), 12, complexity_columns)
level_of_scrutiny25_test = read_file("uploads/{}".format(sys.argv[2]), 15, scrutiny_columns)
grid_mean_test = pd.read_csv("uploads/{}".format(sys.argv[3]), skiprows=20, sep=' ', header=None, names=grid_mean_columns)
